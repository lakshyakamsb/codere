      ...
      <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" style={divStyle}>
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/image/selider1.jpg" alt="Slide 1" />
          </div>
          <div className="carousel-item">
            <img src="image/selider2.jpg" className="d-block w-100" alt="Slide 2" />
          </div>
          <div className="carousel-item">
            <img src="image/selider3.jpg" className="d-block w-100" alt="Slide 3" />
          </div>
        </div>
